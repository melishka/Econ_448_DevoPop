...
4.2 Filter your observations so that you only have women in your sample who are single, married, and divorced. Then create a new variable that indicates whether the woman has ever been married. Plot the proportion of women ever married by age, from age 18 to 65. 
