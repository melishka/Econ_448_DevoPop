...
```{r}
myname<-"knoxm@uw.edu" 
mypass<-"mysecretpassword" #Your actual password here
```
...
So, what do you think about Malthus's conjecture? Can you repeat with another country with more years of data, like Sweden? Country codes are here: https://www.mortality.org/Data/DataAvailability and Sweden's is SWE. Note: Malthus actually wrote about Sweden and their propensity for vice and reliance on positive population checks.
