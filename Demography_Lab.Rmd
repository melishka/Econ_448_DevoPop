...
subtitle: "Demography Lab for Problem Set 1"
---

## Setup
Remember to install packages when necessary and always load them using the library command.

```{r message=FALSE, warning=FALSE}
## Packages you may need - should not need to load in RStudio Server. Only need to load once in your personal machine.
